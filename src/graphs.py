...
def build_graph(dict_edges, dict_args: dict = {}, edge_threshold: int = 0, node_threshold: int = 0, node_size=None, edge_size=None,
    ...
    for edge in list(G.edges):
        if G.nodes[edge[0]]["hidden"]:               G.edges[edge]["hidden"] = True
        if G.nodes[edge[1]]["hidden"]:               G.edges[edge]["hidden"] = True
        if G.edges[edge]["weight"] < edge_threshold: G.edges[edge]["hidden"] = True
...
def draw_graph(networkx_graph, notebook=True, output_filename="graph.html", width="1000px", height="1000px",
    ...
    :param networkx_graph:  The graph to convert and display.
    :param notebook:        Whether to display in Jupyter.
    :param output_filename: Where to save the converted network
    :param width:           width of the network
    :param height:          height of th network
    :param show_buttons:    Whether to show buttons in saved version of network.
    :param only_physics_buttons: Whether to show only buttons controlling physics of network.
